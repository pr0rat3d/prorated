...
const PRIVACY = {
  en: {
    ...
    sections: [
      ...
      { title: "8. Your License Number", body: "Stored encrypted in our database. Used only to verify you are a licensed trade professional. Never displayed publicly or shared with homeowners. Accessible only to ProRated admin for verification purposes." },
      { title: "8. Your Rights", body: "You have the right to access, correct, delete, and export your data.\n\nTo exercise any of these rights, email hello@prorated.app" },
      { title: "8. Contact", body: "📧 hello@prorated.app\n🛡️ ProRated · Hoover, Alabama, USA\n\nFor homeowner address removal requests, email hello@prorated.app with your address and proof of ownership." },
    ],
  ...
  es: {
    ...
    sections: [
      ...
      { title: "8. Tu Número de Licencia", body: "Almacenado encriptado en nuestra base de datos. Usado solo para verificar que eres un contratista con licencia. Nunca se muestra públicamente ni se comparte con propietarios. Solo accesible para el administrador de ProRated para verificación." },
      { title: "8. Tus Derechos", body: "Tienes derecho a acceder, corregir, eliminar y exportar tus datos.\n\nPara ejercer cualquiera de estos derechos, escribe a hello@prorated.app" },
      { title: "8. Contacto", body: "📧 hello@prorated.app\n🛡️ ProRated · Hoover, Alabama, EE.UU.\n\nPara solicitudes de eliminación de direcciones, envía un correo a hello@prorated.app con tu dirección y prueba de propiedad." },
    ],
