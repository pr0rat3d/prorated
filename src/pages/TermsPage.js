...
const TERMS = {
  ...
  es: {
    ...
    sections: [
      ...
      { title: "8. Ley Aplicable", body: "Estos Términos se rigen por las leyes del Estado de Alabama." },
      { title: "9. Contacto", body: "General: hello@prorated.app" },
    ],
